...
public class CreditInquiry {
    private final MenuOption[] choices = MenuOption.values();
    ...
    private void readRecords(MenuOption accountType)
    {
    ...
    private boolean shouldDisplay(MenuOption accountType, double balance)
    {
